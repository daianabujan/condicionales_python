...
numero_1 = float(input('Ingrese la primer temperatura:\n'))
numero_2 = float(input('Ingrese la segunda temperatura:\n'))
numero_3 = float(input('Ingrese la tercer temperatura:\n'))
