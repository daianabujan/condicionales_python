...
ntexto_1 = (int(texto_1))
ntexto_2 = (int(texto_2))
...
if ntexto_1 > ntexto_2:
    print('{} es mayor que {}'.format(ntexto_1, ntexto_2))
elif ntexto_1 == ntexto_2:
    print('{} es igual que {}'.format(ntexto_1, ntexto_2))
else:
    print('{} es mayor que {}'.format(ntexto_2, ntexto_1))
